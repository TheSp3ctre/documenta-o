    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:pl-[260px]">
        <div className="mx-auto max-w-[768px] px-5 py-10 sm:px-8 md:px-12 md:py-16">
          ...
          <h1 className="mt-3 text-[28px] sm:text-[36px] font-semibold leading-[1.2] tracking-[-0.02em] text-foreground">
            Introduction
          </h1>
          <p className="mt-3 text-[16px] sm:text-[17px] leading-relaxed text-muted-foreground">
          ...
          <div className="mt-12 prose-content">
            <section id="overview">
              <h2 className="mt-12 text-[22px] sm:text-[24px] font-semibold tracking-[-0.01em] text-foreground">Overview</h2>
              <p className="mt-4 text-[15.5px] sm:text-[16px] leading-[1.7] text-foreground">
            ...
            <section id="why-verdant">
              <h2 className="mt-12 text-[22px] sm:text-[24px] font-semibold tracking-[-0.01em] text-foreground">Why Verdant</h2>
              <p className="mt-4 text-[15.5px] sm:text-[16px] leading-[1.7] text-foreground">
                Most frameworks optimize for the first ten minutes of a project. Verdant optimizes for the next ten
                years. We invest in <code className="rounded bg-code-bg px-1.5 py-0.5 text-[13.5px] sm:text-[14px] text-forest">predictable defaults</code>,
            ...
            <section id="architecture">
              <h2 className="mt-12 text-[22px] sm:text-[24px] font-semibold tracking-[-0.01em] text-foreground">
            ...
            <section id="example">
              ...
              <p className="mt-4 text-[15.5px] sm:text-[16px] leading-[1.7] text-foreground">
                ...
                <code className="rounded bg-code-bg px-1.5 py-0.5 text-[13.5px] sm:text-[14px] text-forest">minimal</code> template —
                roughly 40 lines of generated code, all of which you're encouraged to read.
              </p>
              <CodeBlock language="bash" code={installCode} />
              <p className="mt-4 text-[15.5px] sm:text-[16px] leading-[1.7] text-foreground">
                Open <code className="rounded bg-code-bg px-1.5 py-0.5 text-[13.5px] sm:text-[14px] text-forest">http://localhost:3000</code>{" "}
            ...
            <section id="next-steps">
              <h2 className="mt-12 text-[22px] sm:text-[24px] font-semibold tracking-[-0.01em] text-foreground">Next steps</h2>
              <p className="mt-4 text-[15.5px] sm:text-[16px] leading-[1.7] text-foreground">
